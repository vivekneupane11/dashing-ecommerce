    ...
    <div className={styles.sideBarCategory}>
      ...
      <aside className={styles.color}>
        ...
        <div className={styles.colorGrid}>
          <span style={{backgroundColor:'yellow'}}> </span> <span style={{backgroundColor:'green'}}> </span> <span style={{backgroundColor:'pink'}}> </span> <span style={{backgroundColor:'white'}}> </span>
          <span style={{backgroundColor:'red'}}> </span> <span style={{backgroundColor:'gray'}}> </span> <span style={{backgroundColor:'gold'}}> </span>
          <span style={{backgroundColor:'brown'}}> </span> <span style={{backgroundColor:'purple'}}> </span> <span> </span>
        </div>
      </aside>
      ...
      <aside className={styles.services}>
        ...
        <section className={styles.serviceIcon}>
          <span>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="blue" height={32} width={32}>
