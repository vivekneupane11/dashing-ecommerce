          ...
          <div className={styles.productDetails}>
            <div className={styles.detailContent}>
              ...
              <div className={styles.description}>
                <strong>
                  <strong>Descriptions : </strong>There a wooden gbox that comes
                  out with the watchThere a wooden golden plate box that comes
                  out with the watchThere a wooden golden plate box that comes
                  out with the watchThere a wooden golden plated shinged color
                  box that comes out with the watch.
                </strong>
              </div>
        ...
        <div>
          <div className={styles.productDescriptionContainer}>
            <div className={styles.productDescriptionTitles}>
              ...
              <span className={styles.shareButton}></span>
            </div>
